...
static void Mugshots_CreateTrainerPics(struct Task *task)
{
    ...
    SetOamMatrixRotationScaling(opponentSprite->oam.matrixNum, opponentRotationScales, opponentRotationScales, 0);    SetOamMatrixRotationScaling(playerSprite->oam.matrixNum, -512, 512, 0);
}
