...
static const u8 sSpeciesToBackAnimSet[NUM_SPECIES] =
{
    ...
    [SPECIES_RAICHU_ALOLAN]     = BACK_ANIM_SHAKE_FLASH_YELLOW,
    [SPECIES_SANDSHREW]  = BACK_ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_SANDSHREW_ALOLAN]  = BACK_ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_SANDSLASH]  = BACK_ANIM_CONCAVE_ARC_LARGE,
    [SPECIES_SANDSLASH_ALOLAN]  = BACK_ANIM_CONCAVE_ARC_LARGE,
    ...
    [SPECIES_MEOWTH_ALOLAN]     = BACK_ANIM_CONCAVE_ARC_LARGE,
    [SPECIES_PERSIAN]    = BACK_ANIM_TRIANGLE_DOWN,
    [SPECIES_PERSIAN_ALOLAN]     = BACK_ANIM_TRIANGLE_DOWN,
    ...
    [SPECIES_SLOWPOKE_GALARIAN]   = BACK_ANIM_H_SLIDE,
    [SPECIES_SLOWBRO]    = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_SLOWBRO_GALARIAN]    = BACK_ANIM_DIP_RIGHT_SIDE,
    ...
    [SPECIES_VOLTORB_HISUIAN]    = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_ELECTRODE]  = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_ELECTRODE_HISUIAN]  = BACK_ANIM_JOLT_RIGHT,
    ...
    [SPECIES_SLOWKING_GALARIAN]   = BACK_ANIM_DIP_RIGHT_SIDE,
