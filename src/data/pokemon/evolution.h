const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_PIKACHU]               = {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_RAICHU_ALOLAN}},
    ...
    [SPECIES_VENONAT]               = {{EVO_LEVEL, 29, SPECIES_VENOMOTH}},
    ...
    [SPECIES_RHYHORN]               = {{EVO_LEVEL, 37, SPECIES_RHYDON}},
#if P_GEN_4_POKEMON == TRUE
    [SPECIES_RHYDON]                = {{EVO_TRADE_ITEM, ITEM_PROTECTOR, SPECIES_RHYPERIOR}},
#endif
    [SPECIES_CHANSEY]               = {{EVO_LEVEL, 65, SPECIES_BLISSEY}},
#if P_GEN_4_POKEMON == TRUE
    ...
    [SPECIES_SEADRA]                = {{EVO_LEVEL, 47, SPECIES_KINGDRA}},
    [SPECIES_GOLDEEN]               = {{EVO_LEVEL, 29, SPECIES_SEAKING}},
    [SPECIES_STARYU]                = {{EVO_ITEM, ITEM_WATER_STONE, SPECIES_STARMIE}},
    [SPECIES_SCYTHER]               = {{EVO_LEVEL, 45, SPECIES_SCIZOR}},
#if P_GEN_4_POKEMON == TRUE
    ...
    [SPECIES_PORYGON]               = {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_PORYGON2}},
    ...
    [SPECIES_TOGEPI]                = {{EVO_LEVEL, 28, SPECIES_TOGETIC}},
#if P_GEN_4_POKEMON == TRUE
    ...
    [SPECIES_NINCADA]               = {{EVO_ITEM, ITEM_LEAF_STONE, SPECIES_NINJASK},
                                       {EVO_MAPSEC, MAPSEC_BATTLE_FRONTIER, SPECIES_SHEDINJA}},
    ...
    [SPECIES_BARBOACH]              = {{EVO_LEVEL, 29, SPECIES_WHISCASH}},
    ...
    [SPECIES_MAKUHITA]              = {{EVO_LEVEL, 28, SPECIES_HARIYAMA}},
    ...
    [SPECIES_AZURILL]               = {{EVO_LEVEL, 9, SPECIES_MARILL}},
    ...
    [SPECIES_RAYQUAZA]              = {{EVO_MOVE_MEGA_EVOLUTION, MOVE_METEOR_BEAM, SPECIES_RAYQUAZA_MEGA}},
    ...
    [SPECIES_SLOWPOKE_GALARIAN]     = {{EVO_ITEM, ITEM_SHINY_STONE, SPECIES_SLOWBRO_GALARIAN},
