static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_PACIFIDLOG_TOWN - 1] = {MAP_GROUP(PACIFIDLOG_TOWN), MAP_NUM(PACIFIDLOG_TOWN), 8, 17},
    ...
    [HEAL_LOCATION_SOOTOPOLIS_CITY_LEGENDS_BATTLE - 1] = {MAP_GROUP(SOOTOPOLIS_CITY_LEGENDS_BATTLE), MAP_NUM(SOOTOPOLIS_CITY_LEGENDS_BATTLE), 30, 20},
};
