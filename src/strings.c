...
const u8 gText_DefaultNameStu[] = _("SUE");
const u8 gText_DefaultNameMilton[] = _("MALCOLM");
const u8 gText_DefaultNameTom[] = _("JOB");
const u8 gText_DefaultNameKenny[] = _("KEITH");
const u8 gText_DefaultNameReid[] = _("REID");
const u8 gText_DefaultNameJude[] = _("ZEKE");
const u8 gText_DefaultNameJaxson[] = _("GERARD");
const u8 gText_DefaultNameEaston[] = _("DIGNAN");
const u8 gText_DefaultNameWalker[] = _("ROBIN");
const u8 gText_DefaultNameTeru[] = _("LIAM");
const u8 gText_DefaultNameJohnny[] = _("OISIN");
const u8 gText_DefaultNameBrett[] = _("SHOHEI");
const u8 gText_DefaultNameSeth[] = _("COSMO");
const u8 gText_DefaultNameTerry[] = _("BART");
const u8 gText_DefaultNameCasey[] = _("ISHMAEL");
const u8 gText_DefaultNameDarren[] = _("CALEB");
const u8 gText_DefaultNameLandon[] = _("RIVERS");
const u8 gText_DefaultNameCollin[] = _("ENZO");
const u8 gText_DefaultNameStanley[] = _("REGGIE");
const u8 gText_DefaultNameQuincy[] = _("DADE");
const u8 gText_DefaultNameKimmy[] = _("EVE");
const u8 gText_DefaultNameTiara[] = _("ANYA");
const u8 gText_DefaultNameBella[] = _("CAOIMHE");
const u8 gText_DefaultNameJayla[] = _("AMAYA");
const u8 gText_DefaultNameAllie[] = _("DAHLIA");
const u8 gText_DefaultNameLianna[] = _("NADIA");
const u8 gText_DefaultNameSara[] = _("SAKURA");
const u8 gText_DefaultNameMonica[] = _("OPHELIA");
const u8 gText_DefaultNameCamila[] = _("DOROTHY");
const u8 gText_DefaultNameAubree[] = _("CANDACE");
const u8 gText_DefaultNameRuthie[] = _("ETHEL");
const u8 gText_DefaultNameHazel[] = _("AGNES");
const u8 gText_DefaultNameNadine[] = _("BERNICE");
const u8 gText_DefaultNameTanja[] = _("OPAL");
const u8 gText_DefaultNameYasmin[] = _("CLEO");
const u8 gText_DefaultNameNicola[] = _("MAEVE");
const u8 gText_DefaultNameLillie[] = _("OLGA");
const u8 gText_DefaultNameTerra[] = _("ARIA");
const u8 gText_DefaultNameLucy[] = _("CLARA");
const u8 gText_DefaultNameHalie[] = _("ADA");
