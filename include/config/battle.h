...
#define B_RECALC_TURN_AFTER_ACTIONS GEN_3 // In Gen8, switching/using a move affects the current turn's order of actions.
...
#define B_UPDATED_CONVERSION        GEN_3 // In Gen6+, Conversion changes the user's type to match their first move's. Before, it would choose a move at random.
...
#define B_GLARE_GHOST               GEN_3 // In Gen4+, Glare can hit Ghost-type Pokémon normally.
...
#define B_TELEPORT_BEHAVIOR         GEN_3 // In Gen7+, starting with Pokémon LGPE, Teleport allows the user to swap out with another party member.
...
#define B_DIVE_BALL_MODIFIER        GEN_3 // In Gen4+, Dive Ball's effectiveness increases by when Surfing or Fishing.
...
#define B_SECRET_POWER_EFFECT       GEN_3 // Secret Power's effects change depending on terrain and generation. See GetSecretPowerMoveEffect.
